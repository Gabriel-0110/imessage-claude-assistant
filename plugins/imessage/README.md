...
**3. Relaunch with the local-development channel flag.**
...
Because this is a local fork, Claude treats it as a development channel rather than
an approved channel plugin. When prompted, choose `1. I am using this for local development`.
